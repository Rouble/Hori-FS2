...
static STDMETHODIMP prop_sheet_query_interface(IDIGameCntrlPropSheet *this, REFIID iid, LPVOID *obj);
...
static STDMETHODIMP prop_sheet_get_sheet_info(IDIGameCntrlPropSheet *this, LPDIGCSHEETINFO *sheet_info);
static STDMETHODIMP prop_sheet_get_page_info(IDIGameCntrlPropSheet *this, LPDIGCPAGEINFO *page_info);
