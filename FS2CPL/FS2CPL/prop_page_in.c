...
#define AXIS_FRONT_COLOR RGB(0xff, 0x00, 0x00)
#define AXIS_BACK_COLOR RGB(0x00, 0x00, 0x00)
#define BUTTON_COLOR(val) RGB(val, 0x00, 0x00)
#define MODIFIER_COLOR(val) RGB(val * 0xff, 0x00, 0x00)
#define POV_FRONT_COLOR RGB(0xff, 0x00, 0x00)
...
static int input_draw_h_axis(HWND hwnd, HDC hdc, UCHAR val)
{
	...
	brush = CreateSolidBrush(RGB(0xff, val, 0x00));
...
static int input_draw_hv_axis(HWND hwnd, HDC hdc, UCHAR val1, UCHAR val2)
{
    ...
    GetClientRect(hwnd, &rect);
    black_brush = CreateSolidBrush(AXIS_BACK_COLOR);
	brush = CreateSolidBrush(RGB(0xff, val1, 0x00));
	pen = CreatePen(PS_SOLID, 0, RGB(0xff, val2, 0x00));
