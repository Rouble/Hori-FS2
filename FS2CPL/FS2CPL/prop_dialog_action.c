...

/* prototypes */
void action_dlg_update_page(prop_page_context_t *ctx);

void action_dlg_joy_update_state(prop_page_context_t *ctx);
void action_dlg_joy_update_val(prop_page_context_t *ctx);

void action_dlg_mou_update_state(prop_page_context_t *ctx);
void action_dlg_mou_update_val(prop_page_context_t *ctx);
